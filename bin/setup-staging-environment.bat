:: ################################################################################################################
:: # symfony-project-template - Windows - Docker-compose - Start staging containers                                    #
:: # @author: Axel Salem                                                                  #
:: ################################################################################################################
...
TITLE symfony-project-template Containers - Rebuild the staging container set.
...
:explain
ECHO.
ECHO Usage: build-staging-docker-containers.bat [OPTION]
ECHO Build staging containers for all environments for this project.
ECHO.
...
ECHO.
ECHO -----------------------------------------------------------------------
ECHO (Re)generating / (re)starting staging (staging) containers
